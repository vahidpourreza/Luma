...
using Luma.Extensions.ObjectMappers.AutoMapper.Options;
using Luma.Extensions.ObjectMappers.AutoMapper.Services;
...
public static class AutoMapperServiceCollectionExtensions
{
    ...
    public static IServiceCollection AddLumaAutoMapperProfiles(this IServiceCollection services, IConfiguration configuration, string sectionName)
        => services.AddLumaAutoMapperProfiles(configuration.GetSection(sectionName));

    public static IServiceCollection AddLumaAutoMapperProfiles(this IServiceCollection services, IConfiguration configuration)
    {
    ...
    public static IServiceCollection AddLumaAutoMapperProfiles(this IServiceCollection services, Action<AutoMapperOption> setupAction)
    {
