...
using Luma.Extensions.MessageBus.RabbitMQ.Options;
using Luma.Extensions.MessageBus.RabbitMQ;
...
public static class RabbitMqMessageBusServiceCollectionExtensions
{
    ...
    public static IServiceCollection AddLumaRabbitMqMessageBus(this IServiceCollection services, IConfiguration configuration, List<Type>? commands = null, Dictionary<string, List<Type>>? events = null)
    {
    ...
    public static IServiceCollection AddLumaRabbitMqMessageBus(this IServiceCollection services, IConfiguration configuration, string sectionName, List<Type>? commands = null, Dictionary<string, List<Type>>? events = null)
    {
        services.AddLumaRabbitMqMessageBus(configuration.GetSection(sectionName));
        return services;
    }

    public static IServiceCollection AddLumaRabbitMqMessageBus(this IServiceCollection services, Action<RabbitMqOptions> setupAction, List<Type>? commands = null, Dictionary<string, List<Type>>? events = null)
    {
