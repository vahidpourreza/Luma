...
using Luma.Extensions.Caching.Distributed.Sql.Options;
using Luma.Extensions.Caching.Distributed.Sql.Services;
...
{
    public static IServiceCollection AddLumaSqlDistributedCache(this IServiceCollection services, IConfiguration configuration, string sectionName)
        => services.AddLumaSqlDistributedCache(configuration.GetSection(sectionName));

    public static IServiceCollection AddLumaSqlDistributedCache(this IServiceCollection services, IConfiguration configuration)
    {
    ...
    public static IServiceCollection AddLumaSqlDistributedCache(this IServiceCollection services, Action<DistributedSqlCacheOptions> setupAction)
    {
        services.AddTransient<ICacheAdapter, DistributedSqlCacheAdapter>();
