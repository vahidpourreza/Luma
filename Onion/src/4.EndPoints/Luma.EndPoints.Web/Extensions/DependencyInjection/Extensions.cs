using Luma.Extensions.DependencyInjection.Abstractions;
...
public static class Extensions
{
    ...
    public static IServiceCollection AddLumaDependencies(this IServiceCollection services, params string[] assemblyNamesForSearch)
    {
        var assemblies = GetAssemblies(assemblyNamesForSearch);

        services.AddLumaApplicationServices(assemblies)
                .AddLumaDataAccess(assemblies)
                .AddLumaUntilityServices()
