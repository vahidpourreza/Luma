...
using Luma.Core.ApplicationServices.Events;
...
{
    public static IServiceCollection AddLumaApplicationServices(this IServiceCollection services, IEnumerable<Assembly> assembliesForSearch)
