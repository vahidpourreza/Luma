...
using Luma.EndPoints.Web.Extensions;
using Luma.Extensions.Serializers.Abstractions;
using Luma.Utilities;
using Microsoft.AspNetCore.Mvc;
using System.Net;

namespace Luma.EndPoints.Web.Controllers;
...
public class BaseController : Controller
{
    ...
    protected LumaServices LumaApplicationContext => HttpContext.LumaApplicationContext();
