...
namespace Luma.Utilities.SerilogRegistration.Enrichers;
public class LumaApplicaitonEnricher : ILogEventEnricher
{
    private readonly SerilogApplicationEnricherOptions _options;
    public LumaApplicaitonEnricher(IOptions<SerilogApplicationEnricherOptions> options)
    {
