...
using Luma.Utilities.Auth.ApiAuthentication.Options;

namespace Luma.Extensions.DependencyInjection;

public static class ApiAuthenticationServiceCollectionExtensions
{
    public static IServiceCollection AddLumaApiAuthentication(this IServiceCollection services, IConfiguration configuration, string sectionName)
        => services.AddLumaApiAuthentication(configuration.GetSection(sectionName));

    public static IServiceCollection AddLumaApiAuthentication(this IServiceCollection services, IConfiguration configuration)
    {
    ...
    public static IServiceCollection AddLumaApiAuthentication(this IServiceCollection services, Action<ApiAuthenticationOption> action)
    {
