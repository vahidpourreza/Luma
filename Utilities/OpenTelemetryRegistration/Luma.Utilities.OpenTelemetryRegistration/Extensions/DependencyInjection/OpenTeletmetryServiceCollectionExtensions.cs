using Luma.Utilities.OpenTelemetryRegistration.Monitoring;
using Luma.Utilities.OpenTelemetryRegistration.Options;
...
{
    public static IServiceCollection AddLumaObservabilitySupport(this IServiceCollection services, IConfiguration configuration)
    {
    ...
    public static IServiceCollection AddLumaObservabilitySupport(this IServiceCollection services, IConfiguration configuration, string sectionName)
    {
        services.AddLumaObservabilitySupport(configuration.GetSection(sectionName));
        return services;
    }

    public static IServiceCollection AddLumaObservabilitySupport(this IServiceCollection services, Action<OpenTeletmetryOptions> setupAction)
    {
    ...
    public static IApplicationBuilder UseLumaObservabilityMiddlewares(this IApplicationBuilder app)
    {
